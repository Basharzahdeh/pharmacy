                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          onTap: () async {
                            await authController.forgotPassword()?Get.offAll(Forogt_Password()): Get.snackbar(
                          ...
                          builder: (ctx) => Align(
                            ...
                            child: InkWell(
                              onTap: () async{
                                ...
                                await Storage().setLoginSkip();
                                await authController.signInAny().then((value) =>Get.offAll(() => Main_Screen()));
                              },
                              child: Row(mainAxisAlignment: MainAxisAlignment.end,
                                children: const [
                                  Text('Skip',style: TextStyle(fontSize: 30,fontWeight: FontWeight.w400),),
